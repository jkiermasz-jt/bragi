    ...
    enum Clockingdetail {
        ...
        enum Break {
            enum Bottomsheet {
                ...
                enum Infohint {
                    static let deductedbreak = tr("Localizable", "clockingdetail_break_bottomsheet_infohint_deductedbreak", fallback: "This break deduction was automatically applied for this workplace. To change it, please contact your Job&Talent account manager.")
                }
                enum Subtitle {
